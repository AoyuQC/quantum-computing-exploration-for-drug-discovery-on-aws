...
prefix = Path("/home/conda/feedstock_root/build_artifacts/psi4_1683815724905/work/build/stage".replace("\\", "/"))
cmake_install_bindir = "bin".replace("\\", "/")
cmake_install_datadir = "share".replace("\\", "/")
cmake_install_libdir = "lib".replace("\\", "/")
pymod_install_libdir = "/python3.10/site-packages".lstrip("/")
...
executable_exe = (Path("/home/rco/Desktop/projects/qfold/quantum-computing-exploration-for-drug-discovery-on-aws/source/src/notebook/healthcare-and-life-sciences/c-1-protein-folding-quantum-random-walk/quantum-random-walk/psi4/psi4conda") / "Scripts" / "psi4.exe").resolve(strict=False)
...
import sys
if "OFF".upper() in ["1", "ON", "YES", "TRUE", "Y"]:  # PCMSolver
    sys.path.insert(1, "")
if "".upper() in ["1", "ON", "YES", "TRUE", "Y"]:  # cppe
    sys.path.insert(1, "")
if "OFF".upper() in ["1", "ON", "YES", "TRUE", "Y"]:  # pyddx
    sys.path.insert(1, "")
if "OFF".upper() in ["1", "ON", "YES", "TRUE", "Y"]:  # pylibefp
    sys.path.insert(1, "")
