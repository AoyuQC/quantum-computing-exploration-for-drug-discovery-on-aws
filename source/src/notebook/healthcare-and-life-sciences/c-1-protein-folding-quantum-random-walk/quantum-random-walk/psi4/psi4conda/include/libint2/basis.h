...
namespace libint2 {
  ...
  template <typename ShellRange> size_t max_size(const ShellRange& shells) {
    size_t n = 0;
    for (auto&& shell: shells)
  ...
  class BasisSet : private std::vector<libint2::Shell> {
    public:
       ...
       *         <li> hardwired to directory \c /home/rco/Desktop/projects/qfold/quantum-computing-exploration-for-drug-discovery-on-aws/source/src/notebook/healthcare-and-life-sciences/c-1-protein-folding-quantum-random-walk/quantum-random-walk/psi4/psi4conda/share/libint/2.7.2/basis </li>
       *       </ol>
       */
...
#else
          path = std::string("/home/rco/Desktop/projects/qfold/quantum-computing-exploration-for-drug-discovery-on-aws/source/src/notebook/healthcare-and-life-sciences/c-1-protein-folding-quantum-random-walk/quantum-random-walk/psi4/psi4conda/share/libint/2.7.2");
#endif
        }
